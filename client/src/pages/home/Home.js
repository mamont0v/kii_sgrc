    ...
    return (
        <>
            <div className="content-home">
                ...
                <ul>
                    <li>Инвентаризация ИТ-инфраструктуры. Формы для заполнения персонала, ИТ-активов организации и другие;</li>
                    <li>Учет материальных и нематериальных активов и их взаимосвязей (процессы, информация, информационные системы, сети, оборудование, пользователи, группы ИТ-активов). Связь персонала и активов между собой. Включение персонала к органищации и т.п.</li>
                    <li>Проведение оценки их ценности</li>
                </ul>
